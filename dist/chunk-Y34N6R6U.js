...
var DataTable = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("overflow-auto border rounded-md", className), children: [
    /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsx("thead", { className: "bg-muted", children: /* @__PURE__ */ jsx("tr", { children: tableColumns.map((column) => /* @__PURE__ */ jsx("th", { className: "px-4 py-2 text-left font-medium", children: column }, column)) }) }),
      /* @__PURE__ */ jsx("tbody", { children: displayData.map((row, index) => /* @__PURE__ */ jsx("tr", { className: "border-t", children: tableColumns.map((column) => /* @__PURE__ */ jsx("td", { className: "px-4 py-2", children: String(row[column] || "") }, column)) }, index)) })
    ] }),
    maxRows && data.length > maxRows && /* @__PURE__ */ jsxs("div", { className: "px-4 py-2 text-sm text-muted-foreground bg-muted", children: [
      "Showing ",
      maxRows,
      " of ",
      data.length,
...
export { Chart, DataTable, Dialog, DialogClose, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogOverlay, DialogPortal, DialogTitle, DialogTrigger, cn };
//# sourceMappingURL=chunk-Y34N6R6U.js.map
//# sourceMappingURL=chunk-Y34N6R6U.js.map